  ...
  return (
    <div>
      <div className="relative">
        ...
        <div
          className="relative min-h-[70vh] flex items-center justify-center md:justify-start" 
          style={{
      ...
      <section className="bg-[#fcf4d9] py-16 px-10 font-montagu flex items-center justify-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center w-full max-w-7xl mx-auto">
          <div className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-[#3b2222]">Rekomendasi Terbaik & Terdekat</h3>
            <p className=" text-gray-600 text-center text-sm">Temukan coffee shop terbaik di sekitar Anda yang direkomendasikan oleh komunitas lokal.</p>
          </div>
          <div className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
            <img src={iconKuliner} alt="Kuliner" className="w-20 h-20 mb-4" />
            <h3 className="text-xl font-bold text-[#3b2222] mb-2">Kuliner Lokal Yang Unik</h3>
            <p className=" text-gray-600 text-center text-sm">Temukan kuliner khas yang hanya bisa kamu rasakan di coffee shop lokal pilihan kami.</p>
          </div>
          <div className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
            <img src={iconCoworking} alt="Co-Working" className="w-20 h-20 mb-4" />
            <h3 className="text-xl font-bold text-[#3b2222]">Co-Working & Komunitas</h3>
            <p className=" text-gray-600 text-center text-sm">Ngopi sambil produktif! Tempat ideal untuk kerja bareng teman atau membangun relasi baru.</p>
          </div>
        </div>
      </section>
      <Footer />
